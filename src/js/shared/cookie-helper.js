// one module can store few factories or contorllers etc.
angular.module('cookie-helper-module', ['app-helper-module'])
    .factory('cookie-helper', ['app-helper', function (appHelper) {
        var cookieHelper = {};
